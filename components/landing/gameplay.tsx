...
export const Gameplay = () => {
  return (
    <>
      <section
        id="gameplay"
        className="clip-path-two relative z-[8] -mb-[4.7rem] grid h-[50rem] w-full items-center justify-center bg-slate-600 pt-[4rem] lg:h-[55rem] lg:pt-0"
      >
        <img
          ...
          alt=""
        />
        <div className="z-[1] flex flex-col gap-14 text-white lg:flex-row">
          ...
          <div className="flex flex-col gap-4">
            <div className="h-[12.5rem] w-[23rem] rounded-xl border-4 border-white bg-white/40 md:h-[20rem] md:w-[45rem] lg:h-[32.5rem] lg:w-[55rem] lg:border-[6px]"></div>
